...
trait IntfDept
{
    ...
    public function createDepartment($data)
    {
        ...
        $url = WechatConst::URL_QY_CGI_PREFIX . '/department/create?access_token=' . $wxAccToken;
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_QY_CGI_PREFIX . '/department/update?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_QY_CGI_PREFIX . '/department/delete', [
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_QY_CGI_PREFIX .  '/department/move?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url,  self::json_encode($data));
        return $result;
    }
    /**
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_QY_CGI_PREFIX . '/department/list', [
            'access_token' => $wxAccToken,
        ]);
        return $result;
    }
