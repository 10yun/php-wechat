...
trait IntfTags
{
    ...
    public function createTag($data = [])
    {
        ...
        $url = WechatConst::URL_QY_CGI_PREFIX .  '/tag/create?access_token=' . $wxAccToken;
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_QY_CGI_PREFIX . '/tag/update?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_QY_CGI_PREFIX . '/tag/delete', [
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_QY_CGI_PREFIX . '/tag/get', [
            'access_token' => $wxAccToken,
            'tagid' => $tagid,
        ]);
        return $result;
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_QY_CGI_PREFIX . '/tag/addtagusers?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    public function delTagUser($data)
    {
        ...
        $url = WechatConst::URL_QY_CGI_PREFIX . '/tag/deltagusers?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_QY_CGI_PREFIX . '/tag/list', [
            'access_token' => $wxAccToken
        ]);
        return $result;
    }
