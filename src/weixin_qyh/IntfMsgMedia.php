...
trait IntfMsgMedia
{
    ...
    public function uploadMedia($data, $type)
    {
        ...
        $url = WechatConst::URL_QY_CGI_PREFIX . self::MEDIA_UPLOAD . 'access_token=' . $wxAccToken . '&type=' . $type;
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_QY_CGI_PREFIX . '/media/get', [
