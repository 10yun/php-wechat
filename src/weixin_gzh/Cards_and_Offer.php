...
class Cards_and_Offer extends WechatCommon
{
    ...
    public function createCardQrcode($card_id, $code = '', $openid = '', $expire_seconds = 0, $is_unique_code = false, $balance = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/qrcode/create?access_token=' . $wxAccToken;
    ...
    public function getCardIdList($offset = 0, $count = 50)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/batchget?access_token=' . $wxacctoken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_API_BASE_PREFIX . '/card/getcolors', [
    ...
    public function wxBatchGet(int $offset = 0, int $count = 0)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/location/batchget?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function addCardLocations($data)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/location/batchadd?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/update?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/create?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    public function wxCardGetInfo($card_id)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/get?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxCardWhiteList($openid = array(), $user = array())
    {
        ...
        if (count($user) > 0)
            $data['username'] = $user;
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/testwhitelist/set?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url,  self::json_encode($data));
        return $result;
        return true;
    }
    ...
    public function wxCardConsume($code, $card_id = '')
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/code/consume?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxCardDelete($card_id)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/delete?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    public function wxCardDecryptCode($encrypt_code)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX .  '/card/code/decrypt?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/modifystock?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return true;
        return $result;
    }
    ...
    public function wxCardQueryCode($code, $cardId = '')
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/code/get?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/membercard/activate?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url,  self::json_encode($data));
        return true;
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url =  WechatConst::URL_API_BASE_PREFIX .  '/card/membercard/updateuser?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url,  self::json_encode($data));
        return $result;
    }
    ...
    public function updateLuckyMoney($code, $balance, $card_id = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX .  '/card/luckymoney/updateuserbalance?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url,  self::json_encode($data));
    ...
    public function updateCardCode($code, $card_id, $new_code)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX .  '/card/code/update?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return true;
        return $result;
    }
    ...
    public function unavailableCardCode($code, $card_id = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . '/card/code/unavailable?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return true;
        return $result;
    }
