...
trait IntfShakearound
{
    ...
    public function wxDeviceApply($data)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/device/applyid?access_token={$wxAccToken}";
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/device/update?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return true;
        return $result;
    }
    ...
    public function wxDeviceBindLocation($device_id, $poi_id, $uuid = '', $major = 0, $minor = 0)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/device/bindlocation?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return true;
        return $result;
    }
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/device/search?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function addShakeAroundPage($title, $description, $icon_url, $page_url, $comment = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/page/add?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxPageUpdate($page_id, $title, $description, $icon_url, $page_url, $comment = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/page/update?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function searchShakeAroundPage($page_ids = array(), $begin = 0, $count = 1)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/page/search?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxPageDelete($page_ids = array())
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/page/delete?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxMaterialAdd($media = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/material/add?access_token={$wxAccToken}";
    ...
    public function wxDeviceBindPage($device_id, $page_ids = array(), $bind = 1, $append = 1, $uuid = '', $major = 0, $minor = 0)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/device/bindpage?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxGetShakeInfo($ticket)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/user/getshakeinfo?access_token={$wxAccToken}";
    ...
    public function wxGetShakeStatistics($device_id, $begin_date, $end_date, $uuid = '', $major = 0, $minor = 0)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/shakearound/statistics/device?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    public function pageShakeAroundStatistics($page_id, $begin_date, $end_date)
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . '/shakearound/statistics/page?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
}
