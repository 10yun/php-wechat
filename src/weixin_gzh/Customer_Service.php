...
class Customer_Service extends WechatCommon
{
    ...
    public function wxServiceAdd(string $account = '', string $nickname = '', string $password = '')
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/customservice/kfaccount/add?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    public function wxServiceUpdate($account, $nickname, $password)
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/customservice/kfaccount/update?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    ...
    public function wxServiceUpdateCover(string $kf_account = '', string $media = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/customservice/kfaccount/uploadheadimg?access_token={$wxAccToken}&kf_account=" . $kf_account;
        $result = HelperCurl::curlHttpPost($url, $data);
    ...
    public function wxServiceDelete(string $kf_account = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/customservice/kfaccount/del?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, $data);
        return $result;
    }
    ...
    public function wxServiceSessionAdd(string $openid = '', string $kf_account = '', string $text = '')
    {
        ...
        if (!empty($text))
            $data["text"] = $text;
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . "/customservice/kfsession/create?access_token={$wxAccToken}";
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    public function wxServiceSessionClose(string $openid = '', string $kf_account = '', string $text = '')
    {
        ...
        $wxAccToken = $this->wxAccessToken();
        $url = WechatConst::URL_API_BASE_PREFIX . '/customservice/kfsession/close?access_token=' . $wxAccToken;
        $result = HelperCurl::curlHttpPost($url, self::json_encode($data));
        return $result;
    }
    /**
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_API_BASE_PREFIX . '/customservice/kfsession/getsession', [
            'access_token' => $wxAccToken,
            'openid' => $openId,
        ]);
        return $result;
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_API_BASE_PREFIX . '/customservice/kfsession/getsessionlist', [
            'access_token' => $wxAccToken,
            'kf_account' => $kf_account,
        ]);
        return $result;
    ...
    {
        $wxAccToken = $this->wxAccessToken();
        $result = HelperCurl::curlHttpParamGet(WechatConst::URL_API_BASE_PREFIX . '/customservice/kfsession/getwaitcase', [
            'access_token' => $wxAccToken,
        ]);
        return $result;
    }
