...
trait IntfService
{
    ...
    public function xcxDoGetData($code = '', string $encryptedData = '', $iv = '')
    {
         ...
         */
        $XcxResultArr = HelperCurl::curlHttpParamGet(WechatConst::URL_API_BASE_PREFIX . '/sns/jscode2session', [
            'appid' => $this->_appID,
    ...
    public function getWXACodeUnlimit($page, $scene = '')
    {
        ...
        $url = WechatConst::URL_API_BASE_PREFIX . "/wxa/getwxacodeunlimit?access_token={$wxAccToken}";
