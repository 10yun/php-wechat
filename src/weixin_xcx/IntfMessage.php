...
trait IntfMessage
{
    ...
    public function messageSend($config = array(), $template = array(), $touser = '', $type = 'weapp_template_msg')
    {
        ...
        // dd(json_encode($data[']));
        // \shiyunUtils\libs\LibsLogger::getInstance()->setGroup('weixin_xcx')->writeDebug(($data, 'UniformMessage' . date("Y-m-d"));
        // $url =  "https://api.weixin.qq.com/cgi-bin/message/wxopen/template/uniform_send?access_token={$access_token}";
        $url =  "https://api.weixin.qq.com/cgi-bin/message/subscribe/send?access_token={$access_token}";
        $result = HelperCurl::curlHttpPost($url, json_encode($data['weapp_template_msg']));
        // \shiyunUtils\libs\LibsLogger::getInstance()->setGroup('weixin_xcx')->writeDebug(($jsoninfo, 'xcxTemplateMessage' . date("Y-m-d"));
        return $result;
    }
    ...
    public function messageSendSubscribe($config = array(), $template = array(), $touser = '')
    {
        ...
        // \shiyunUtils\libs\LibsLogger::getInstance()->setGroup('weixin_xcx')->writeDebug(($jsoninfo, 'xcxTemplateMessage/sendXcxSubscribe' . date("Y-m-d"));
        return $result;
    }
}
